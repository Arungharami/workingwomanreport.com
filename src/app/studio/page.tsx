    ...
    return (
      <div className="container-shell max-w-3xl py-10">
        ...
        <p className="mt-5 text-sm leading-7 text-[var(--ink-muted)]">
          The internal content-preparation screen is disabled. Set
          ENABLE_STUDIO=true in a local or protected environment to review
          weekly packages, social copy, SEO, accessibility, and publishing
          checklist items.
        </p>
  ...
  return (
    <div className="container-shell py-10">
      ...
      <p className="mt-4 max-w-3xl text-sm leading-6 text-[var(--ink-muted)]">
        No automatic posting happens here. This screen prepares copy,
        metadata, accessibility checks, and Allison approval before publishing.
      </p>
      <div className="mt-10">
